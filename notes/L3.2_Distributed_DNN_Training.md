...
Modern models can be hundreds of GBs:
- Example: 350 GB model / 8 GPUs = 43.75 GB per GPU
- But even the best GPUs have 40-80 GB memory
- **Large models simply cannot fit!**

This is what motivates Model Parallelism.
